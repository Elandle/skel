...
#                             v                          elow       time 
bounds= tuple([(1, 100) for i in range((N+ 1)//2)]+ [(1, 100)]+ [(0, 100)])
...
filedata= open("HtoPSecondData.txt", "a")
fileminima= open("HtoPSecondMinima.txt", "a")

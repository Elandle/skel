...
run= "fixedu Hubbard 0.9904599676492388 3.0 19.756922349839446 4 1 1 0,0 3,3 0.44667982909520254,1.6461515831168911,0.44667982909520254"
run= run.split()
e= float(run[3])
time= float(run[4])
N= int(run[5])
...
#                 vc         tc        elow
bounds= tuple([(1, 15)]+ [(0.999999, 1.000000001)]+ [(5, 15)])
...
model= "Pam"
normalizationdata= "fromhubbardvc"
...
filedata= open("PamDualAnnealingFromHubbardvc.txt", "a")
fileminima= open("PamDualAnnealingFromHubbardvc.txt", "a")

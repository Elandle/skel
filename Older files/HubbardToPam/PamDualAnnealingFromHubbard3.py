...
run= "fixedu Hubbard 0.9992224180601761 0.5 18.847407002004044 4 1 1 0,0 3,3 6.557300241245351,9.16409821127179,6.557300241245351"
run= run.split()
e= float(run[3])
...
#                             v                         tc        elow        time
bounds= tuple([(0.1, 10) for i in range((N+ 1)//2)]+ [(0, 2)]+ [(5, 20)]+ [(0, 50)])
...
model= "Pam"
normalizationdata= "fromhubbardvc3"
...
filedata= open("PamDualAnnealingFromHubbardvc3.txt", "a")
fileminima= open("PamDualAnnealingFromHubbardvc3.txt", "a")

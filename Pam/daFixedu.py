...
if guessmethod== 0:
    ...
    guess= guesst[:N//2]+ guessv[:(N+ 1)//2]+ [guesselow]+ [guesstime]
if guessmethod== 1:
    #       t   v   elow   time
    guess= [                   ] 
...
filedata= open("pamdaFixeduData.txt", "a")
fileminima= open("pamdaFixeduMinima.txt", "a")
...
# x=[t[0], t[1], t[2], ..., t[N//2], v[0], v[1], ..., elow, time]
def minfideven(x):
